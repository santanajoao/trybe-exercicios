...
for (let numero = fimIntervalo-1; numero > inicioIntervalo; numero -= 1) {
  // inicia do 2 pois todos os números entre 2 e 50 tem
  // 2 divisores triviais (1 e ele mesmo)
  let numeroDivisores = 2;
  let raiz = Math.floor(numero ** (1 / 2)) + 1;

  // inicia do 2 pois 1 é divisor de todo número e termina na
  // raiz pois é o maior divisor que pode existir além do próprio número
